 ...
 * <code>site.hadef.database1.service.impl.RegionLocalServiceImpl</code> and
...
public class RegionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>site.hadef.database1.service.impl.RegionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static site.hadef.database1.model.Region addRegion(
	 ...
	 */
	public static site.hadef.database1.model.Region createRegion(long id) {
	 ...
	 */
	public static site.hadef.database1.model.Region deleteRegion(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the region that was removed
	 */
	public static site.hadef.database1.model.Region deleteRegion(
		site.hadef.database1.model.Region region) {
	...
	public static site.hadef.database1.model.Region fetchRegion(long id) {
	 ...
	 * @throws PortalException if a region with the primary key could not be found
	 */
	public static site.hadef.database1.model.Region getRegion(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<site.hadef.database1.model.Region> getRegions(
		int start, int end) {
	 ...
	 */
	public static site.hadef.database1.model.Region updateRegion(
		site.hadef.database1.model.Region region) {
